 ...
 */
const val PACKAGE = "com.dong.library.reader"
const val SEPARATOR = "_"
const val PROJECT_NAME = "KReader"
const val ROUTE_LOADER_NAME = "$PROJECT_NAME${SEPARATOR}KReaderLoader"
...
/**
 * 获取对象对应带有inject扩展方法的对象名，如：需要被注入的对象com.*.A在编译后会生成一个负责注入的对象com.*.com_*_A_KReader_Injector
 ...
 * @return 将对象名称中的"."替换为"_"，并添加"_KReader_Injector"后缀
 */
